...
namespace MyGame
{
    ...
    public class LayerAdderEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                SGD_Layers[] arr = System.Enum.GetValues(typeof(SGD_Layers)) as SGD_Layers[];

                foreach (SGD_Layers r in arr)
                {
            ...
            if (GUILayout.Button("Set Default Layer Collisions"))
            {
                ...
                Physics.IgnoreLayerCollision(dic[SGD_Layers.CHARACTER.ToString()], dic["Default"], false);
              //  Physics.IgnoreLayerCollision(dic[SGD_Layers.DEADBODY.ToString()], dic["Default"], false);
